...
((core) =>
{
    ...
    {
      // hide the error message div element
      $("#ErrorMessage").hide();
      ...
      var passInput = validatePassword();
      validateConfirmPassword(passInput);
    }

    function validateFirstName()
    {
      // first name must contain at least two characters. Letters only.
      ...
      $("#firstName").on("blur", function()
      {
        ...
        {
          // display with error message element
          $(this).trigger("focus").trigger("select");
          $("#ErrorMessage").show().addClass("alert alert-danger").text("First name must contain at least 2 letters.");
        }
        else
        {
    ...
    {
      // last name must contain at least two characters. Letters only.
      let pattern = /([A-Z,a-z]{2})/;
      ...
      $("#lastName").on("blur", function()
      {
        ...
        if(!pattern.test($(this).val()))
        {
          // display with error message element
          $(this).trigger("focus").trigger("select");
          $("#ErrorMessage").show().addClass("alert alert-danger").text("Last name must contain at least 2 letters.");
        }
        else
        {
          // validates, so remove the error message
