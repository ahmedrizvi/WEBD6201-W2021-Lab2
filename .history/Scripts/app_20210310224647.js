    ...
    function validateFirstName()
    {
      ...
      $("#FirstName").on("blur", function()
      {
        ...
        if(!pattern.test($(this).val()))
        {
          ...
          $(this).trigger("focus").trigger("select");
          $("#ErrorMessage").show().addClass("alert alert-danger").text("First name must contain at least 2 characters.");
        }
        else
        {
    ...
    function validateLastName()
    {
      ...
      $("#LastName").on("blur", function()
      {
        ...
        if(!pattern.test($(this).val()))
        {
          // display with error message element
          $(this).trigger("focus").trigger("select");
          $("#ErrorMessage").show().addClass("alert alert-danger").text("Last name must contain at least 2 characters.");
        }
        else
        {
          // validates, so remove the error message
